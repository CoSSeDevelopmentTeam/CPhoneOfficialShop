...
public enum BuyItem {
    ...
    ACACIA_WOOD(17, 4, "Acacia Wood", "アカシアの丸太", 100),
    DARK_OAK_WOOD(17, 5, "Dark Oak Wood", "ダークオークの丸太", 100),
    ...
    LIGHT_GRAY_STAINED_GLASS(35, 8, "Light Gray Wool", "薄灰色のウール", 200),
